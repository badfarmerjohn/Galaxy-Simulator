...
if __name__ == "__main__":
    ...
    f_pix = open(base_name + "_pix_array.txt", "w")
    ...
    f_h_mean = open(base_name + "_h_mean_array.txt", "w")
    f_s_mean = open(base_name + "_s_mean_array.txt", "w")
    f_v_mean = open(base_name + "_v_mean_array.txt", "w")
    ...
    f_h_std = open(base_name + "_h_std_array.txt", "w")
    f_s_std = open(base_name + "_s_std_array.txt", "w")
    f_v_std = open(base_name + "_v_std_array.txt", "w")
